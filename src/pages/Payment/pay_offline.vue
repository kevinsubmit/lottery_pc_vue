<template>
  <div class="payment">
    <h4>
      <i :class="`ico ${bankName==='微信'?'ico-my-wechat': bankName==='支付宝' ? 'ico-my-alipay': bankName=== 'QQ' ? 'ico-my-qq' :bankName==='京东支付' ? 'ico-my-jd' : 'ico-my-bank' }`"></i>
    ...
    <div>
        ...
        <table class="bank-offline-table userTable">
          ...
          <tr v-if="isShowOrderNum && bankName != '银行支付'">
            <th>商户单号后四位</th>
            <td><el-input v-model="orderNo"   :minlength="4" :maxlength="4" placeholder="商户单号后四位"></el-input></td>
          </tr>
