      ...
      <el-main>
        <el-row :gutter="20" style='margin-bottom:10px'>
          ...
          <el-col :span="3">
            <div class="grid-content bg-purple">
              <div class="zhuan1">
                <el-radio v-model="radio" label="0">捕鱼转彩票</el-radio>
              </div>
            </div>
          </el-col>
          <el-col :span="3">
            <div class="grid-content ">
              <div class="zhuan1">
                <el-radio v-model="radio" label="1">彩票转捕鱼</el-radio>
              </div>
            </div>
          </el-col>
        </el-row>
        ...
        this.$http
          ...
          .then(res => {
            ...
            if (res.data.msg == 7001) {
              ...
              if (this.radio == 1) {
                this.$swal({
                  text: "彩票成功转入捕鱼额度" + res.data.amount + "元",
                  type: "success",
                  timer: 1200
                })
                  .then(function(response) {})
                ...
                loadingInstance.close();
                this.$swal({
                  text: "捕鱼额度成功转入彩票" + res.data.amount + "元",
                  type: "success",
                  timer: 1200
                })
                  .then(function(response) {})
