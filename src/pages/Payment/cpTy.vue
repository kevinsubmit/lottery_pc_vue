  ...
  <div id="transfer">
		  ...
		  <el-main>
				  ...
				  <el-col :span="3"><div class="grid-content ">
				  	 <div class="zhuan1">
				  	 	<el-radio ref="cp" v-model="radio" label="1">彩票转体育</el-radio>
				  	 </div>
				  </div></el-col>
					<el-col :span="3"><div class="grid-content bg-purple">
				  	 <div class="zhuan1">
				  	 	<el-radio ref="cp" v-model="radio" label="0">体育转彩票</el-radio>
				  	 </div>
				  </div></el-col>
				</el-row>
      ...
      submit(){
	      	if(this.shu<=0||this.shu==''){
                ...
                params.client_type =  0; 
                   ...
                   //彩票体育额度转换的接口
		      	 this.$http.post('/user/conversionCash',JSON.stringify(params)).then(res => {
                    console.log(res)
		      	 	...
		      	 	if(res.data.msg==7001){ 
		    			...
		    			loadingInstance.close();
		      	 		...
		      	 		if(this.radio==1){
					        this.$swal({
					          text: '彩票成功转入体育'+res.data.amount+'元', 
					          type: "success",
					          timer: 1200, 
					        })
					        .then(function (response) {
					        ...
					        this.$emit('sportSuccess', 'sportSuccess');
		      	 		
		      	 		}else if(this.radio==0){
		      	 			loadingInstance.close();
					        this.$swal({
					          text: '体育成功转入彩票'+res.data.amount+'元', 
					          type: "success",
					          timer: 1200, 
					        })
					        .then(function (response) {
