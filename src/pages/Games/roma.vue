  ...
  methods: {
    ...
    fetchData(i) {
      ...
      if (i != 1) {
        ...
        if (
          localStorage.getItem("roma_list_0") &&
          localStorage.getItem("roma_list_1") &&
          localStorage.getItem("roma_list_2") &&
          JSON.parse(localStorage.getItem("roma_list_0")).msg !== 4001
        ) {
