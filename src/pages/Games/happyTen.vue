        ...
        <div class="bet-box">
          ...
          <div class="bet-area" :class="type" v-if="param.type_code===9">
            <div class="game" id="farm_lm">
              ...
              <div class="lm_ball ">
                <ul class="">
                  <li v-for="i in [1,6,11,16,2,7,12,17,3,8,13,18,4,9,14,19,5,10,15,20]" @click.stop.prevent="toggleCheckbox">
  ...
  methods: {
    ...
    lianmCheck(e, a) {
      ...
      for (let i = 0; i < this.$refs.check.length; i++) {
        ...
        // this.$refs.check[i].disabled = false;
      }
      this.typecode = e;
      switch (e) {
        case 2032:
