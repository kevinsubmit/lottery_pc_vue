...
export default {
    ...
    methods: {
      ...
      fetchData(i) {
        ...
        if (i!=1) {         let lmp = {},gyh = {},ydw = {}
         lmp.game_code = 250;lmp.type_code = 0;
         gyh.game_code = 250;gyh.type_code = 1;
         ydw.game_code = 250;ydw.type_code = 2;
  ...
  watch: {
    endtime: function() {
      if (this.endtime == 0||this.endtime ==30||this.endtime ==178||this.endtime ==176||this.endtime ==174) {
        this.fetchData(1);
        this.showDialog = false;
      }
    }
