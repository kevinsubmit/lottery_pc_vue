<template>
  <div>
    ...
    <div class="float-right" :class='{isshow:Showsmall}'>
        <ul class="clearfix">
            <li class="weixin clearfix"  title="聊天室"></li>            
            <li class="cs clearfix" @click="openService"  title="在线客服"></li>
...
.float-right .cs {
  ...
  width: 50px;
  background: url('@{public_img}/images/common/icon/ico-right-cs.png') no-repeat center center #1c4fa8;
}
.float-right .weixin{
  border-radius:3px 3px 0 0;
  width: 50px;
  background: url('@{public_img}/images/common/icon/ico-right-call.png') no-repeat center center #1c4fa8;
}
.float-right .weijie {
  margin-top:3px;
  border-radius:3px;
  background: url('@{public_img}/images/common/icon/ico-right-weijie.png') no-repeat 12px center #1c4fa8;
  padding-right: 10px;
  transition: all ease 1s;
}
.total{background: url('@{public_img}/images/common/icon/ico-right-weijie.png') no-repeat 12px center #1c4fa8;}
</style>
<style scoped>
